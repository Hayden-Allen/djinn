declare interface _Nanovg {
    ...
    fillArc(x: number, y: number, r: number, start: number, end: number, dir: number): void
    ...
    strokeArc(x: number, y: number, r: number, start: number, end: number, dir: number): void
